...
<!--            <nav class="navbar navbar-expand-xl">
            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container h-100">
                    <a class="navbar-brand" href="index.html">
                        <h1 class="tm-site-title mb-0">Admin - Delete Product</h1>
                    </a>
...
<!--                                                                                                                  <input type="number" name="cat_id">-->
            <option value ="<%=s.getP_id()%>" ><%=s.getP_name()%></option>
                                                                                                                        <!--                                        <tr>  
         ...
         <tr><td><br></td></tr>
         <tr>   
          <td><input type="submit" value="Delete" class="btn btn-primary btn-block text-uppercase mb-3"/></td>    
         </tr>    
        </table>    
       </form> 
