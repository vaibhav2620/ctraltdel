...
<!--            <nav class="navbar navbar-expand-xl">
            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container h-100">
                    <a class="navbar-brand" href="index.html">
                        <h1 class="tm-site-title mb-0">Admin - Add Event</h1>
                    </a>
...
<!--                                <a class="nav-link d-block" href="login.html">
        ...
        <table >    
         <tr>    
          <!--<td>ID : </td>-->  
          <!--<td><input type = number class="form-control"      placeholder="Enter id" name="e_id" /></td>-->  
         </tr>
         <tr>
             <tr>    
          <td><br></td>  
         ...
         <tr>
          <td>Name : </td>  
          <td><input class="form-control" type="text" placeholder="Event name"  name="e_name"/></td>  
         </tr>
          <tr>    
          <td><br></td>  
          <td><br></td>  
