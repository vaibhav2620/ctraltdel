...
<!--            <nav class="navbar navbar-expand-xl">
            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container h-100">
                    <a class="navbar-brand" href="index.html">
                        <h1 class="tm-site-title mb-0">Admin - Add Product</h1>
                    </a>
...
<!--                                                                                                                  <input type="number" name="cat_id">-->
            ...
            <br > <br >                                      
            <label>image</label>
            <input type="file" name="imagePath" style="width:300px;" class="btn btn-primary btn-block text-uppercase mb-3">
            <br><br>
            <button type="submit" value="add" style="width:100px;" class="btn btn-primary btn-block text-uppercase mb-3">ADD</button>
        </form>
    </body>
</html>
