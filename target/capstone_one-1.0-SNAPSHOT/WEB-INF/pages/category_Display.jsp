                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                            ...
                            <div class="tm-product-table-container">
                                <table class="table tm-table-small tm-product-table" style="font-size: large;">
                                    <tbody>
                                        ...
                                        %>      
                                        <tr>  
                                            <td class="tm-product-name" style="font-size: large;"><%=s.getCat_id()%></td>
                                            <td class="tm-product-name" style="font-size: large;"><%=s.getCat_name()%></td>
