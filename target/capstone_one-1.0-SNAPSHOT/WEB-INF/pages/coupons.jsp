                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto h-100">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link " href="products_display">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="coupon_display">
      ...
      <br>      <br>
                       ...
                       <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                            <h2 class="tm-block-title">Event Coupons</h2>
                            <div class="tm-product-table-container">
                                <table class="table tm-table-small tm-product-table">
                                    <tbody>
                                        ...
                                        %>      
                                        <tr>  
                                            <td class="tm-product-name" style="font-size:large;"><%=s.getCoupon_id()%></td>
                                            <td class="tm-product-name" style="font-size:large;"><%=s.getCoupon_name()%></td>
                                            <td class="tm-product-name" style="font-size:large;"><%=s.getDiscount()%></td>
