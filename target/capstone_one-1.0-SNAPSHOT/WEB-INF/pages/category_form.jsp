...
<!--            <nav class="navbar navbar-expand-xl">
            ...
            <nav class="navbar navbar-expand-xl">
                <div class="container h-100">
                    <a class="navbar-brand" href="index.html">
                        <h1 class="tm-site-title mb-0">Admin - Add Category</h1><br>
...
<!--                                <a class="nav-link d-block" href="login.html">
    ...
    <body>
        ...
        <table >    
         <tr>    
          <td>ID : </td>  
          <td><input type = number class="id input" placeholder="Enter id" name="cat_id" /></td>  
         </tr>
         <tr><td><br></td></tr>
         <tr>    
          <td>Name : </td>  
          <td><input type="text" class="name input" placeholder="category name"  name="cat_name"/></td>  
         </tr>
          <tr><td><br></td></tr>

         <tr>    
          <td><input type="submit" value="Save" class="btn btn-primary btn-block text-uppercase mb-3"/></td>    
         </tr>    
        </table>    
       </form> 
