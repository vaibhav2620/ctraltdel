      ...
      <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
              <h1 class="tm-block-title">products</h1>
...
<!--                    <th scope="col">&nbsp;</th>-->
                ...
                <tbody>
                    <%
                                            ...
                                            List<products> ob = (List<products>) request.getAttribute("list");
                                            for (products s : ob) {
                                        %>      
                                        <tr>  
                                            <td class="tm-product-name" style="font-size: large;"><%=s.getP_id()%></td>  
                                            <td class="tm-product-name" style="font-size: large;"><%=s.getP_name()%></td>     
                                             <td class="tm-product-name" style="font-size: large;"><%=s.getCost()%></td> 
                                             <td class="tm-product-name" ><img src="<%=s.getImgpath()%>" alt="alt" style="width:50px;height:50px;"/></td> 
                                               <td class="tm-product-name" style="font-size: large;"><%=s.getCat().getCat_name()%></td>
                                               <td class="tm-product-name"><a href="update_product/<%=s.getP_id()%>"><i class="fa-regular fa-pen-to-square" style="font-size: large;"></i></a></td>
